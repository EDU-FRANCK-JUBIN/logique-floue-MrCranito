...
power = ctrl.Consequent(np.arange(0.0, 3.0, 0.1), 'power')
...
power_simu = ctrl.ControlSystemSimulation(power_ctrl)

power_simu.input['temperature'] = 40
power_simu.input['humidity'] = 40

power_simu.compute()

print(power_simu.output['power'])
power.view(sim=power_simu)
